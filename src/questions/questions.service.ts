...
export class QuestionsService {
    ...
    async findAvailableQuestions(userId: number): Promise<CustomDataResponse<AvailableQuestionsResponseDTO | AvailableQuestionsResponseDTO[]>> {
        try {
            ...
            // 유저에게 조건에 만족하는 question이 없는 경우 code 1 & message: '조회 가능한 데이터가 없습니다' return
    ...
    async submitQuestion(userId: number, submitQuestionRequestDTO: SubmitQuestionRequestDTO): Promise<CustomDataResponse<SubmitQuestionResponseDTO>> {
